...
import ShowInfo from '../portfolio/accueil/ShowInfo';

function Card(props) {
    return(
		<div className="card col-10 col-md-5 m-5 align-items-center">
			<div className="col-10 shadow rounded">
				<img src={process.env.PUBLIC_URL + "/portfolio/img/"+props.projet.pictures} className="card-img-top img-fluid mt-n1"/>
			</div>
